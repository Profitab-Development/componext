          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            ...
            <div>
              ...
              "
                  style={{ fontFamily: 'Suisse Intl, system-ui, sans-serif' }}
              >
                Компанія Компонекст – офіційний імпортер інноваційних
                композитних матеріалів із Німеччини та Італії:
                Xenia, Siltex, ThermHex.
              </p>
            </div>
            ...
            <div>
              ...
              "
              >
                Ми спеціалізуємось на постачанні композитних,
                термопластичних матеріалів в Україну від найкращих
                виробників Європи:
              </p>
              ...
              "
              >
                Наші рішення знаходять застосування в авіації,
                автоспорті, суднобудуванні, енергетиці, оборонній та
                будівельній галузях тощо.
              </p>
            </div>
          </div>
        </div>
