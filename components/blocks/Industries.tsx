...
// Constants
const INDUSTRIES: Industry[] = [
  { id: 'aerospace', title: 'Авіакосмічна промисловість', icon: '/img/industries/Icon Frame.svg' },
  { id: 'automotive', title: 'Автомобілебудування та автоспорт', icon: '/img/industries/Icon Frame-1.svg' },
  { id: 'defense', title: 'Оборонна галузь', icon: '/img/industries/Icon Frame-2.svg' },
  { id: 'marine', title: 'Суднобудування та морська інфраструктура', icon: '/img/industries/Icon Frame-3.svg' },
  { id: 'oil-gas', title: 'Нафтогазова промисловість', icon: '/img/industries/Icon Frame-4.svg' },
  { id: 'construction', title: 'Будівництво та архітектура', icon: '/img/industries/Icon Frame-5.svg' },
  { id: 'energy', title: 'Енергетика та ізоляційні системи', icon: '/img/industries/Icon Frame-6.svg' },
  { id: 'manufacturing', title: 'Виробництво інструментів, форм і прототипів', icon: '/img/industries/Icon Frame-7.svg' },
]
