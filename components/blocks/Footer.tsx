  ...
  return (
    <footer
      className="
        ...
        pt-[40px] pb-[40px]      /* мобільні відступи */
        lg:pt-15 lg:pb-15        /* десктоп як було */
      "
    >
      {/* === MOBILE BACKGROUND === */}
      <div className="absolute inset-0 z-0 lg:hidden">
        <Image
          src="/img/footer/footer_bg_mob.webp"
      ...
      {/* CONTENT */}
      <div className="relative z-10 container-1320 px-4">
        {/* Logo — збільшений нижній відступ на мобільній версії */}
        <Link
          href="/"
          className="flex items-center justify-center mb-[70px] lg:mb-25"
        >
          <Image
            src="/Logo.svg"
            width={190}
        ...
        <nav
          className="
            flex w-full max-w-[360px] justify-between mx-auto
            lg:max-w-none lg:justify-center lg:gap-12
            mb-[32px]
          "
        >
        ...
        {/* Copyright */}
        <div className="text-xs leading-6 tracking-[0.2px] text-zinc-500 font-medium font-montserrat text-center">
          {/* Mobile */}
          <div className="flex flex-col items-center gap-1 lg:hidden">
            <span>Designed and Developed by</span>
            <div className="flex items-center gap-2">
