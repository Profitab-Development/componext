...
export const metadata: Metadata = {
  title: 'COMPONEXT | Інноваційні композитні матеріали, термопластичні композити з Європи',
  description:
  ...
  icons: {
    // шлях від кореня сайту (файл лежить у /public)
    icon: '/favicon.png',
  ...
  return (
    <html lang="uk">
      <body
        ...
        className={`${robotoMono.variable} ${montserrat.variable} antialiased`}
      >
        {children}
      </body>
    </html>
